...
Откройте пример [`13_gradients.py`](https://github.com/ShashkovS/drawzero/blob/master/src/drawzero/examples/13_gradients.py) после прочтения этой страницы. Файл также указан в [Примерах](examples.md).
...
* [Примеры](examples.md) – найдите `13_gradients.py` и другие скрипты, которые смешивают градиенты с движением.
